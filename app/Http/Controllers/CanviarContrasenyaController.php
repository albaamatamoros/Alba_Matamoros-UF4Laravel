...
class CanviarContrasenyaController extends Controller {
    ...
    public function contrasenyaOblidada(Request $request) {
        try {
            ...
            throw new Exception("S'ha produït un error inesperat en modificar la contrasenya el personatge.: " . $e->getMessage());
            return back()->withErrors(['general' => "➤ S'ha produit un error inesperat. Torna-ho a intentar més tard."]);
        }
    }
    ...
    public function restablirContrasenya($token) {
        try {
            ...
            throw new Exception("S'ha produït un error inesperat en restablir la contrasenya el personatge.: " . $e->getMessage());
            return back()->withErrors(['general' => "➤ S'ha produit un error inesperat. Torna-ho a intentar més tard."]);
    }
    }
